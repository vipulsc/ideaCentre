...
export function Hero() {
  return (
    <section
      className="px-12 pb-10 pt-4 sm:pb-12 sm:pt-5 md:pt-6 lg:pb-14 lg:pt-8"
      aria-labelledby="hero-heading"
    >
      <div className="mx-auto w-full max-w-screen-2xl 2xl:max-w-400">
        <div
          className="relative overflow-hidden rounded-2xl border border-primary-foreground/20 bg-palette-primary px-6 py-10 text-primary-foreground sm:px-10 sm:py-12 md:px-12 md:py-14 lg:px-12 lg:py-16 xl:rounded-3xl xl:px-14 xl:py-20"
        >
